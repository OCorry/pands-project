...
For this project I needed the relevant programming environment on my PC. This included two software packages: namely Cmder and Visual Studio (VS) Code. I also needed to create a repository on my Github to allow me to push up my work so that it could be accessed from another machine.
...
I found that using plt.show() just once would print out all of the plots generated from the code used in the lines above it. To allow the user to control what plots they wanted to print, I used code plt.close() at the end of each block of code for each individual plot (Geeks for Geeks, 2020). The user could then comment out this code, depending on which plot they wanted printed in the terminal. 
...
<img src="./Sepal Length.png" width =400 height =400>               <img src="./Sepal Width.png" width =400 height =400>  


 
<img src="./Petal Length.png" width =400 height =400>               <img src="./Petal Width.png" width =400 height =400>
...
However, taking for example the sepal length and sepal width of the Iris-virginica, there is very low correlation between them as the plot is not compact and it does not fit well around the straight line. This means that there is little connection between the sepal length and sepal width in terms of their growth.  

<img src="./Petal Length and Petal Width.png" width =400 height =400>     <img src="./Petal Length and Sepal Length.png" width =400 height =400>      


<img src="./Petal Length and Sepal Width.png" width =400 height =400>     <img src="./Sepal Length and Petal Width.png" width =400 height =400>  


<img src="./Sepal Length and SepalWidth.png" width =400 height =400>      <img src="./Sepal Width and Petal Width.png" width =400 height =400>
...
Geeks for Geeks, 2020. Matplotlib.pyplot.close() in Python. [Online] 
Available at: https://www.geeksforgeeks.org/matplotlib-pyplot-close-in-python/
[Accessed 5 May 2022].
...
w3schools, 2022. Machine Learning - Standard Deviation. [Online] 
...
Cheung, 2022. Github - How to upload, add + resize images in a markdown file eg README.md [Online]
Available at: https://www.youtube.com/watch?v=teGy35UGnds
[Accessed 05 May 2022].

GitHub, 2022. Basic writing and formatting syntax [Online]
Available at: https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax 
[Accessed 05/05/2022].